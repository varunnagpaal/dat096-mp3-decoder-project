...
You can convert MP3 files to SREC format by following command;
	./bin2srec -o 41000000 -a 4 -l 16 [input mp3 file] > [output srec file]
EX:
	./bin2srec -o 41000000 -a 4 -l 16 PapaRoach-Forever.mp3 >PapaRoachmp3.srec

Notes:
0x41000000 is defined as starting address in compat.c. Any change in this address must be applied to compat.c too.
